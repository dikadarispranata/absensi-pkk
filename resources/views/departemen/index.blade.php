    ...
    <body>
        <div class="p-5">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <form method="GET" action="{{ route('departemens.index') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-700">Cari Departemen</label>
                        <input list="departemenList" name="nama_departemen" class="w-full border border-gray-300 p-2 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Cari nama departemen..."value="{{ request('nama_departemen') }}">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            @foreach ($departemens as $departemen)
                                <tr class="bg-white hover:bg-gray-50 transition duration-150">
                                    ...
                                    <td class="p-4 text-sm text-gray-700 whitespace-nowrap font-medium">{{ $departemen->nama_departemen }}</td>
        ...
        <div class="relative w-full max-w-md bg-white rounded-lg shadow-lg p-6 mx-4">
            <div class="mt-3">
                <div class="flex justify-between items-center pb-4 border-b border-gray-200">
                    <h3 class="text-xl font-bold text-gray-900">Tambah Departemen</h3>
                ...
                <form action="{{ route('departemens.store') }}" method="POST" class="space-y-6 mt-4">
                    @csrf

                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-700">Nama Departemen</label>
